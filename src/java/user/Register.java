        ...
        try{
            ...
            if(!pass.equals(repass)){
                ...
                if(rs.next()){
                    ...
                    session.setAttribute("alert_message","An error occured while registering new user please try again!");
                    ...
                    if(rc>0){   //rc willl be >0 if the row gets inserted
                        ...
                        session.setAttribute("alert_message","You are registered now proceed to login!");
            ...
            session.setAttribute("alert_message","An error occured while registering new user please try again after sometime!");
            session.setAttribute("alert_type","warning");
            response.sendRedirect("index.jsp");
        }finally{
            out.close();
