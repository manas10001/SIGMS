...
public class CreateSig extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(rs > 0){
                int rs2 = st2.executeUpdate("insert into `group_members` (group_id,user_id,designation) values('"+sigid+"', '"+session.getAttribute("uid")+"' ,'admin' )");
                if(rs2 >0){
                    con.commit();
            ...
            System.out.println("Exception occured while creating sig: ");
            ex.printStackTrace();
        }
