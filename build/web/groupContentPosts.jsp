...
<!--Navigation bar-->
	<nav class="navbar navbar-expand navbar-dark bg-dark fixed-top">
		...
		<!-- Navbar Search -->
		<form class="d-none d-md-inline-block form-inline ml-auto mr-md-3 my-md-0" style="visibility:hidden;" accept-charset="utf-8">
                            ...
                            <div class="card shadow-lg bg-white rounded">
                                    <div class="card-header card-title">
                                        ...
                                        <div style="float:right">
                                            <%
                                                if(moderator || rspost.getString("user_id").equals(session.getAttribute("uid"))){
                                            %>
                                            <button class="btn btn-danger" onclick="location.href='DelElement?id=<%=rspost.getString("post_id")%>&type=post'">Delete Post</button>
                                            <%}%>
<!--                                            <select>
               ...
               <!--COMMENTS SECTION--> 
                ...
                <div class="row answer collapse" id="answer<%=pcounter%>" style="padding-top:1vh;">
                    <div class="profile">
                        <img src="img/user-solid.svg" style="width:40px;height: 40px;" class="card rounded-circle mx-auto d-block">
                    </div>
                        <div class="text">
                                ...
                                <div class="card shadow bg-white rounded">
                                        ...
                                        <div class="card-body card-question">
                                            <form action="AddComment" method="POST" accept-charset="utf-8">
                                                <textarea style="min-height: 100px; width: 100%;" maxlength="500" placeholder="Write or drag content here..." required name="comment-data"></textarea>
...
<!--            <li class="nav-item">
      ...
      <form action="AddPost" method="POST" accept-charset="utf-8">
        <div class="modal-body" id="#write" style="min-height:300px;">
            <textarea maxlength="500" style="min-height: 300px; width: 100%;" placeholder="Write or drag content here..." required name="post-data"></textarea>
        </div> 
