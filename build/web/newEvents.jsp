                    ...
                    <div class="col-md-4" style="padding-bottom: 2vh;">
                        <div class="card shadow bg-white rounded features-card">
                            ...
                            <div class="card-footer text-muted text-center">
                                ...
                                <button class="btn btn-warning" onclick="location.href='Mailer?msg=Notification For event : <%=rsev.getString("event_name")%> Date: <%=rsev.getString("date")%>&page=newEvents.jsp&eid=<%=rsev.getString("event_id")%>'">Get Notification</button>
                            </div>
                        </div>
                    </div>
