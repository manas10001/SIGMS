        ...
        <div class='card'>
            ...
            <div class="col-md-12">  
                <div class="panel panel-default row card-text">
                    ...
                    <div class="panel-body col-md-4" style="padding-top: 5%;">
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered"  role="document">
    ...
    <form action="CreateSig" method="post">
      <div class="modal-body" id="#write" style="min-height:300px;">
          ...
          <div>
            <textarea maxlength="500" style="min-height: 150px; width: 100%;" placeholder="Describe Your Group" required name="description"></textarea>
          </div>
      </div>
