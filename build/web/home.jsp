...
<div>
    ...
    <%
        ...
        ResultSet rs2 = st2.executeQuery("select group_name,count(group_members.user_id) as count FROM group_details INNER JOIN group_members ON group_details.group_id=group_members.group_id group by group_members.group_id order by count(group_members.user_id) desc limit 6;");
//        rs2.next()
    %>
...
<div>
    <div style="padding-bottom: 2vh;">
        <div class="card shadow bg-white rounded stat-card">
            <div class="card-body text-center text-bold">
                <h4 class="card-title">Groups Having Most Members</h4>
                <table class="table table-striped">
                    ...
                    %>
                    <tr>
                        <td><%=rs2.getString("group_name")%></td>
