    	...
    	<div class="card shadow-lg bg-white rounded">
      		<div class="card-header card-title">
                    <div style="float:left">
                        <h5 class="">Asked By: <%=uname%></h5>
                    </div>
                    <div style="float:right">
                        <%
                            if(moderator || rsque.getString("user_id").equals(session.getAttribute("uid"))){
                        %>
                        <button class="btn btn-danger" onclick="location.href='DelElement?id=<%=rsque.getString("question_id")%>&type=question'">Delete Question</button>
                        <%}%>
<!--                                            <select>
        	...
        	<div class="card-footer">
        		<div>
        			...
        			<div style="float:right;">
        			<button  style="float:right;"data-toggle="collapse" class="btn btn-outline-dark" data-target="#answer<%=qcounter%>">Show Answers</button>
        			<button style="float:right;visibility:hidden" class="btn btn-outline-dark collapse" id="answer1">Add Answer</button>
        		</div>
        		</div>
      		</div>
       	</div>
                ...
                %>
                    ...
                    <div class="row answer collapse" id="answer<%=qcounter%>" style="padding-top:1vh;">
                            <div class="profile">
                                <img src="img/user-solid.svg" style="width:40px;height: 40px;" class="card rounded-circle mx-auto d-block">
                            </div>
                            <div class="text">
            ...
            <div class="card shadow bg-white rounded">
                    ...
                    <div class="card-body card-question">
                            <form action="AddAnswer" method="POST">
                                <textarea style="min-height: 100px; width: 100%;" maxlength="500" placeholder="Write or drag content here..." required name="answer-data"></textarea>
    ...
    <div class="modal-content " style="background:#f8fafb">
      <div class="modal-header text-center">
        ...
        <div class="modal-body" id="#write" style="min-height:300px;">
            <textarea maxlength="500" style="min-height: 300px; width: 100%;" placeholder="Write or drag content here..." required name="question-data"></textarea>
        </div> 
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
          <input type="submit" class="btn btn-primary" value="Ask Question"></input>
        </div>
      </form>
    </div>
  </div>
