...
<div class="row ">
    ...
    <div class="col-sm-3">
        <div class="counterpink card shadow bg-white rounded features-card">
            <div class="card-body text-center text-bold">
                ...
                <br><br>
 <!--START SHOW USER POSTS-->
     <%
        Statement st3 = con.createStatement();
        ResultSet rs2 = st3.executeQuery("select * from post where user_id='"+session.getAttribute("uid")+"' order by posted_on desc ");
 ...
 <div>
    <div style="padding-bottom: 2vh;">
        <div class="card shadow bg-white rounded stat-card">
            <div class="card-body text-center text-bold">
                <h4 class="card-title">Posts By You</h4>
                <table class="table table-striped">
                    ...
                    %>
                    <tr>
                        <td><%=rs2.getString("post")%></td>
                        <td><%=rs2.getString("posted_on")%></td>
                        <td><button class="btn btn-success" onclick="location.href='groupContentPosts.jsp?sigid=<%=rs2.getString("group_id")%>'">Open Group</button></td>
                    </tr>
                    <%
                        }
                    %>
 ...
 <!--END SHOW USER POSTS-->
 <!--START SHOW USER QUESTIONS-->
 <br><br>
     <%
        Statement st4 = con.createStatement();
        ResultSet rs4 = st4.executeQuery("select * from questions where user_id='"+session.getAttribute("uid")+"' order by posted_on desc ");
 ...
 <div>
    <div style="padding-bottom: 2vh;">
        <div class="card shadow bg-white rounded stat-card">
            <div class="card-body text-center text-bold">
                <h4 class="card-title">Questions By You</h4>
                <table class="table table-striped">
                    ...
                    %>
                    <tr>
                        <td><%=rs4.getString("question")%></td>
                        <td><%=rs4.getString("posted_on")%></td>
                        <td><button class="btn btn-success" onclick="location.href='groupContentQuestions.jsp?sigid=<%=rs4.getString("group_id")%>'">Open Group</button></td>
                    </tr>
                    <%
                        }
                    %>
